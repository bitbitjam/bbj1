...
#define OBJECT_COUNT			9		// Defines which FLAG will be used to store the object count.
...
#define AMMO_REFILL				15		// ammo refill, using tile 20 (hotspot #4)
...
#define AMMO_X					8		// 
#define AMMO_Y					21		// Ammo counter character coordinates
#define TIMER_X					99		//
...
unsigned char comportamiento_tiles [] = {
	8, 8, 8, 8, 8, 0, 8, 8, 8, 8, 8, 8, 8, 8, 10, 10,
	8, 0, 0, 8, 0, 0, 8, 8, 8, 8, 8, 8, 8, 0, 0, 0,
	8, 8, 0, 8, 10, 10, 10, 10, 10, 10, 8, 8, 8, 0, 0, 0,
};
#endif
