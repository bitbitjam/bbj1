...
#define COLOR_AZUL_FOREGROUND 1
#define COLOR_ROJO_FOREGROUND 2
#define COLOR_VERDE_FOREGROUND 4
#define COLOR_AZUL_BACKGROUND 8
#define COLOR_ROJO_BACKGROUND 16
#define COLOR_VERDE_BACKGROUND 32
#define COLOR_LIGHT 64
#define COLOR_FLASH 128
#define COLOR_BLANCO_FOREGROUND 7
#define COLOR_BLANCO_BACKGROUND 56
