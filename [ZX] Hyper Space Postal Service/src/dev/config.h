...
#define PLAYER_VY_INICIAL_SALTO 312      // Initial junp velocity (64/64 = 1 píxel/frame)  96
#define PLAYER_MAX_VY_SALTANDO  312     // Max jump velocity (320/64 = 5 píxels/frame)  312
#define PLAYER_INCR_SALTO       312      // acceleration while JUMP is pressed (48/64 = 0.75 píxeles/frame^2)  48
...
#define PLAYER_RX_AIR           4      // Friction (32/64 = 0,5 píxels/frame^2)
