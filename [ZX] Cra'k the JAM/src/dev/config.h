...
#define DMAP_BITSYMB  5                 // data from tmxcompress
...
#define PLAYER_G				128		// Gravity acceleration (32/64 = 0.5 píxeles/frame^2)

#define PLAYER_VY_INICIAL_SALTO 256		// Initial junp velocity (64/64 = 1 píxel/frame)
#define PLAYER_MAX_VY_SALTANDO	320 	// Max jump velocity (320/64 = 5 píxels/frame)
#define PLAYER_INCR_SALTO		0		// acceleration while JUMP is pressed (48/64 = 0.75 píxeles/frame^2)

//#define PLAYER_INCR_JETPAC		32		// Vertical jetpac gauge
//#define PLAYER_MAX_VY_JETPAC	256 	// Max vertical jetpac speed

// IV.2. Horizontal (side view) or general (top view) movement.
//Con el mismo valor aceleracion y friccion ni acelera ni resbala
#define PLAYER_MAX_VX			192	 	// Max velocity (192/64 = 3 píxels/frame)
#define PLAYER_AX				64		// Acceleration (24/64 = 0,375 píxels/frame^2)
#define PLAYER_RX				124		// Friction (32/64 = 0,5 píxels/frame^2)
...
unsigned char comportamiento_tiles [] = {
	0, 16, 0, 0, 0, 0, 4, 8, 8, 0, 1, 0, 0, 0, 0, 0,
	0, 16, 0, 0, 16, 0, 4, 16, 16, 4, 4, 0, 0, 0, 0, 1,
	4, 8, 8, 0, 0, 0, 0, 0, 4, 4, 0, 0, 8, 0, 8, 8, 
	/*JDRO Si se pueden poner más de 48 tiles, descomentamos las dos lineas siguientes:
	  no olvides darle comportamiento a los tiles, IDIOTA
	 */
